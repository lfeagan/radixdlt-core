...
public class ConsensusEventMessageSerializeTest extends SerializeMessageObject<ConsensusEventMessage> {
	...
	private static ConsensusEventMessage get() {
		...
		BFTHeader header = new BFTHeader(View.of(2), Hash.ZERO_HASH, ledgerHeader);
		BFTHeader parent = new BFTHeader(View.of(1), Hash.ZERO_HASH, ledgerHeader);
		BFTHeader commit = new BFTHeader(View.of(0), Hash.ZERO_HASH, ledgerHeader);
