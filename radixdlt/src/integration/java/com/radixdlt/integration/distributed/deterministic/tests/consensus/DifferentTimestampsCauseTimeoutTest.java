...
public class DifferentTimestampsCauseTimeoutTest {
	...
	public void when_four_nodes_receive_qcs_with_same_timestamps__quorum_is_achieved() {
		...
		processingSequence.add(Pair.of(ChannelId.of(0, 1), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(1, 1), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(2, 1), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(3, 1), ViewTimeout.class));
		...
		processingSequence.add(Pair.of(ChannelId.of(0, 2), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(1, 2), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(2, 2), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(3, 2), ViewTimeout.class));
		...
		processingSequence.add(Pair.of(ChannelId.of(0, 3), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(1, 3), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(2, 3), ViewTimeout.class));
		processingSequence.add(Pair.of(ChannelId.of(3, 3), ViewTimeout.class));
